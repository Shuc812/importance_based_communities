...
public class C3_BZ {
	...
	public C3_BZ(String basename) throws Exception {
	...
	void topCom(Integer r, Integer k) {
		...
		System.out.println("(r="+ r +", k=" + k + ") cnt_all=" + cnt_all + ", cnt_good=" + cnt_good);
	...
	public static void main(String[] args) throws Exception {
		...
		//args = new String[] {"data1_astrocnet", "10", "16"}; //graph_basename, r, k
		//args = new String[] {"data12_uk-2005-edgeList", "10", "32"}; //graph_basename, r, k
		
		String basename = args[0];
		int k = Integer.valueOf(args[1]);
		int r = Integer.valueOf(args[2]);
		
		C3_BZ kc = new C3_BZ(basename);		
		kc.topCom( k, r );
